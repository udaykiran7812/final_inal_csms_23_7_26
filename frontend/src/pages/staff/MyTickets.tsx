...
export const StaffMyTickets: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-sm text-slate-500 mt-1">Review list of tickets that you are currently handling.</p>
      </div>
      ...
      {statusFilter && (
        <div className="p-3 bg-indigo-50 border border-indigo-200 rounded-xl flex items-center justify-between text-xs text-indigo-900 font-medium">
          <div className="flex items-center space-x-2">
            ...
            <span>
              Filtered by Status: <strong className="font-bold">{statusFilter}</strong> ({tickets.length} of {rawTickets.length} tasks showing)
            </span>
          </div>
          <button
