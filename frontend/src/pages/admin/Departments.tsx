...
export const AdminDepartments: React.FC = () => {
  ...
  const handleDelete = async (id: number) => {
    if (!window.confirm('Delete this department? This could affect linked staff and tickets.')) return;
    try {
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-slate-500 mt-1">Configure campus service units that resolve support requests.</p>
        </div>
        <button
